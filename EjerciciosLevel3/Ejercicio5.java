...
class Alumno{
    ...
    public String toString(){
        return String.valueOf(this.fechaDeNacimiento)+ " - " + this.nombre + " " + this.apellido;
    }
}
...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        Map<Object, Object> salida = listaAlumnos.stream()
            .collect(Collectors
            .toMap(e -> e.getNyA(), e -> Period.between(e.getFecha(), fechaParaComparar).getYears(),
